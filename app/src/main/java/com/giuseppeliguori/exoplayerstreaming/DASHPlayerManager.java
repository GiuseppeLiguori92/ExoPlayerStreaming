...
public class DASHPlayerManager {
    ...
    public DASHPlayerManager(Context context, Uri uri) {
        this.simpleExoPlayerView = new SimpleExoPlayerView(context);
        init(context, uri);
    }

    public DASHPlayerManager(Context context, SimpleExoPlayerView simpleExoPlayerView, Uri uri) {
    ...
    private void init(Context context, Uri uri) {
        ...
        MediaSource mediaSource = new DashMediaSource(uri, dataSourceFactory,
